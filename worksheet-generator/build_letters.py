...
LETTERS = [
    ...
    {"upper": "Z", "lower": "z",
     ...
     "theme": "lightning", "hunt": ["Z", "y", "A", "z", "Y", "Z", "a", "z"],
     "verb": "Draw a box around each one."},
]
